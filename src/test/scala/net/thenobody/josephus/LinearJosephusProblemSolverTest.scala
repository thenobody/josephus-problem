...
/**
  ...
  */
class LinearJosephusProblemSolverTest extends FlatSpec with Matchers {

  behavior of classOf[LinearJosephusProblemSolver].getSimpleName
  ...
  it should "solve the problem with small input values" in {
    ...
    val instance = new LinearJosephusProblemSolver
